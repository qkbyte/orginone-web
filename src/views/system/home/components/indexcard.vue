  ...
  <div id="indexcard">
    <div class="indexcard-box">
      ...
      <div class="card-bottom" v-if="!getAssetGroup.length">
        <div class="card-item card-color1" @click="skipAssets">
        ...
        <div class="card-item card-color2" @click="skipAssets">
          <div class="card-item-img">
        ...
        <div class="card-item card-color3" @click="skipAssets">
          <div class="card-item-img">
        ...
        <div class="card-item card-color4" @click="skipAssets">
          <div class="card-item-img">
        ...
        <div class="card-item card-color5" @click="skipAssets">
          <div class="card-item-img">
  ...
  methods: {
    ...
    skipAssets(val) {
      if(val == 'all') {
        let menu = {
        id: -1,
        url: 'http://zamsupervice.assetcloud.org.cn/platform/slogin/defalut/zvue/711897411064172544?tenant=jgd',
        type: "app",
      };
      this.changeMenu(menu);
        ...
        let menu = {
        id: -1,
        url: 'http://zamsupervice.assetcloud.org.cn/platform/slogin/defalut/zvue/711897411064172544?tenant=jgd&assetCateCode='+ val.assetCateCode + '&assetCateName=' + val.assetCateName + '&type=seatch&totalCount=' + val.gropDetail.totalCount + '&totalPrice=' + val.gropDetail.totalPrice +'&isCall=yes',
        type: "app",
      };
      this.changeMenu(menu);
      }
