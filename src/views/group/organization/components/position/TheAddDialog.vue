<template>
  ...
  >
    <span slot="title" class="diy-dialog-title"> 新增性质 </span>
    ...
    <div class="body-container body-item">
      ...
      <div class="body-item-main">
        <TheUserTransfer :type="'add'"  class="body-item-main__transfer" ref="userTransfer" :state="1"></TheUserTransfer>
      </div>
    </div>
...
import { groupCreateProperty } from "@api/group";
  ...
  methods: {
    ...
    handleClick() {
      this.$refs.form.validate((valid) => {
        ...
        this.loading = true;
        this.form.tenantIds = this.$refs.userTransfer.$children[0].value.join(",");
        let params = this.form;
        groupCreateProperty(params).then(
          (res) => {
            this.loading = false;
            this.$emit("closeDialog", this.dialogShow.key);
