    ...
    <DiyBoxLayout class="flex-column">
      <template v-slot:tabs>
        <div class="group-select">
          <TheGroupSelect v-if="curGroupId !== ''" @handleUpdate="handleUpdate" style="width:fit-content"></TheGroupSelect>
        </div>
      </template>
      <TheAppList
...
import TheGroupSelect from "../jobComponents/TheGroupSelectMenber.vue";
export default {
  data() {
    return {
  ...
  methods: {
    ...
    handleUpdate() {
      this.fullscreenLoading = true;
      console.log('cur', this.curGroupId);
      if (this.curGroupId == "") {
    ...
    back() {
      this.$router.push("/applicationMarket");
    },
  },
};
</script>
