...
export default {
  ...
  watch:{
    ...
    dialogShow:{
      handler(val){
        this.ruleForm.tenantCode = val.sendData.tenantCode
        this.ruleForm.tenantName = val.sendData.tenantName
        this.ruleForm.tenantType = val.sendData.tenantType
        this.ruleForm.status = val.sendData.status
      },
      deep:true,
      immediate:true
    }
