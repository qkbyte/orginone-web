<template>
  <el-dialog
    title="任务信息"
    :visible.sync="dialogTaskDetailVisibleInChild"
    width="75%"
  >
    <el-form
      ref="dataForm"
      :model="taskDetailData"
      disabled
    ...
    >
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="状态" prop="suspended">
            <el-input
              v-if="taskDetailData.endTime == null"
              v-model="taskDetailData.suspended ? '挂起' : '激活'"
            />
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item
            label="流程定义发布ID"
            prop="processDefinitionDeploymentId"
          >
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="发起人完成任务" prop="initiatorCanCompleteTask">
            <el-select
              v-model="taskDetailData.initiatorCanCompleteTask"
              placeholder="发起人完成任务"
            >
              <el-option
        ...
        <el-col :span="8">
          <el-form-item label="候选组" prop="memberOfCandidateGroup">
            <el-select
              v-model="taskDetailData.memberOfCandidateGroup"
              placeholder="候选组"
            >
              <el-option
                v-for="item in dicts.trueOrFalse"
        ...
        <el-col :span="8">
          <el-form-item label="候选成员" prop="memberOfCandidateUsers">
            <el-select
              v-model="taskDetailData.memberOfCandidateUsers"
              placeholder="候选成员"
            >
              <el-option
                v-for="item in dicts.trueOrFalse"
    ...
    <div slot="footer" class="dialog-footer">
      <el-button
        icon="el-icon-close"
        @click="dialogTaskDetailVisibleInChild = false"
        >取消</el-button
      >
    </div>
  </el-dialog>
