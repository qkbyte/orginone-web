      ...
      <div class="rightTree">
        ...
        >
          <div class="nodeModel" slot-scope="{ node, data }">
            <div class="left">
              <div class="menu-node__header--icon" v-bind:style="{'background-image': 'url(' + data.icon + ')','background-repeat':'no-repeat','background-size':'100% 100%' }">
...
export default {
  ...
  methods: {
    filterNode(value, data) {
      if(data.roleList && !data.roleNameList){
        data.roleNameList = data.roleList
      }
      if (!value) return true;
      return data.roleNameList.includes(value);
    },
    changeRole(val) {
