...
<svg
  ...
  <g pointer-events="fill" oryx:minimumSize="50 40">
   ...
   oryx:anchors="top left"
    ...
    response.data.stencils[9].title='转交节点'
        response.data.stencils[9].view=svgStr2
        response.data.stencils[9].propertyPackages.push('servicetaskdelegateexpressionpackage');
    response.data.stencils[9].propertyPackages.push('servicetaskclasspackage');
    response.data.stencils[9].propertyPackages.push('multiinstance_typepackage');
    response.data.stencils[9].propertyPackages.push('servicetaskexpressionpackage');
       ...
       for( let i=0;i< response.data.propertyPackages.length;i++ ){
        ...
        if(response.data.propertyPackages[i].name=='multiinstance_conditionpackage'){
                        response.data.propertyPackages[i].properties[0].title='会签比例'
                        // response.data.propertyPackages[i].properties[0].type='Boolean'
                        // response.data.propertyPackages[i].properties.push({
                        //     title:'dasdsa'
                        // })
         }
